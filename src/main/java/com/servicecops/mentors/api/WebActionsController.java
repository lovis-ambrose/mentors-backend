package com.servicecops.mentors.api;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.servicecops.mentors.services.WebActionsService;
...
public class WebActionsController {
     ...
     * @see com.servicecops.mentors.services.base.BaseWebActionsService
     *
    ...
    public OperationReturnObject processServiceRequest(@RequestBody @Nullable String requestBody){
        ...
        try {
            ...
            responseWithError.setCodeAndMessageAndReturnObject(500, e.getMessage(), null);
